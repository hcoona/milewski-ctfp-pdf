...
**Note**: This template is filled in by the `/speckit.plan` command. Command template documentation is
currently pending; follow the constitution governance section until the commands directory is restored.
...
**Language/Version**: [Chez Scheme (required) or NEEDS CLARIFICATION]  
**Primary Dependencies**: [Akku packages, Scheme libraries or NEEDS CLARIFICATION]  
**Storage**: [if applicable, e.g., PostgreSQL, CoreData, files or N/A]  
**Testing**: [Chez Scheme test harness name or NEEDS CLARIFICATION]  
...
- ✅ **Location Mapping**: Describe how each pass preserves or augments source location metadata.
