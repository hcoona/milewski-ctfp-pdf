...
- Added sections: Core Principles, Implementation Constraints, Workflow Quality Gates, Governance
...
5. Block merges when any quality gate fails until corrective commits restore compliance.
